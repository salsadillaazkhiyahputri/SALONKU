...
<div class="flex min-h-[70vh] items-center justify-center">
    <div class="w-full max-w-md">
        <div class="mb-8 text-center">
            ...
            <p class="mt-2 text-gray-600">Daftar untuk mulai booking di SalonKu</p>
        </div>
        ...
        <div class="rounded-2xl border border-rose-100 bg-white p-8 shadow-xl shadow-rose-100/50">
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    <label for="phone" class="mb-1.5 block text-sm font-medium text-gray-700">No. Telepon</label>
