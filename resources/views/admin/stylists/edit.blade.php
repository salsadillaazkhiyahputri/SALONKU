...
<div class="mx-auto max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-900">Edit Stylist</h1>

    <div class="mt-6 rounded-2xl border border-rose-100 bg-white p-6 shadow-sm sm:p-8">
        <form method="POST" action="{{ route('admin.stylists.update', $stylist) }}" class="space-y-5">
            @csrf
            @method('PUT')
            @include('admin.stylists._form', ['stylist' => $stylist])
