    ...
    @forelse($categories as $mainCategory)
        <div class="mb-10 space-y-6">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-2xl font-extrabold text-gray-900">{{ $mainCategory->name }}</h2>
            </div>
            
            @forelse($mainCategory->subCategories as $category)
                <div class="overflow-hidden rounded-3xl border border-rose-100 bg-white shadow-lg shadow-rose-100/50 ml-4 sm:ml-8">
            ...
            @empty
                <div class="rounded-3xl border border-dashed border-rose-200 bg-rose-50/50 p-6 text-center ml-4 sm:ml-8 mt-4">
                    <p class="text-sm text-gray-500">Belum ada sub-kategori untuk kategori ini.</p>
                </div>
            @endforelse
        </div>
    @empty
